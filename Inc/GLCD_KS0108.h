...
// typedef enum{
//     GLCD_Driver_DispStatReset_InReset   = (uint8_t)1,
//     GLCD_Driver_DispStatReset_Normal    = (uint8_t)0
// }GLCD_Driver_DispStatReset_TypeDef;
...
GLCD_Status_TypeDef   GLCD_Driver_SetWholeDispColor       (GLCD_Handle_TypeDef* phglcd_, GLCD_Driver_DispHalf_TypeDef hlf_, GLCD_Driver_DispColor_TypeDef init_whole_dsp_clr_); // Set Whole Datas (Color)
...
// Buffering Tools
GLCD_Status_TypeDef   GLCD_Driver_SyncBuff_WriteToDisp    (GLCD_Handle_TypeDef* pglcd1_, GLCD_Driver_DispHalf_TypeDef hlf_);
GLCD_Status_TypeDef   GLCD_Driver_SyncBuff_ReadFromDisp   (GLCD_Handle_TypeDef* pglcd1_, GLCD_Driver_DispHalf_TypeDef hlf_);
