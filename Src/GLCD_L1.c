...
{
    return GLCD_L0_Write(pglcd_, (uint8_t)(GLCD_L1_InsBase_DispOnOff | (on_off_ & GLCD_L1_InsMask_DispOnOff)), GLCD_L0_FrameType_Instruction, hlf_);
}


HAL_StatusTypeDef GLCD_L1_Set_Address(GLCD_L0_TypeDef* pglcd_, GLCD_L0_HALF_TypeDef hlf_,  uint8_t y_addr_)
{
    return GLCD_L0_Write(pglcd_, (uint8_t)(GLCD_L1_InsBase_SetAdddress | (y_addr_ & GLCD_L1_InsMask_SetAdddress)) , GLCD_L0_FrameType_Instruction, hlf_);
}


HAL_StatusTypeDef GLCD_L1_Set_Page(GLCD_L0_TypeDef* pglcd_, GLCD_L0_HALF_TypeDef hlf_,  uint8_t page_)
{
    return GLCD_L0_Write(pglcd_, (uint8_t)(GLCD_L1_InsBase_SetPage | (page_ & GLCD_L1_InsMask_SetPage)), GLCD_L0_FrameType_Instruction, hlf_);
}


HAL_StatusTypeDef GLCD_L1_Set_DispStartLine(GLCD_L0_TypeDef* pglcd_, GLCD_L0_HALF_TypeDef hlf_,  uint8_t dsp_strt_ln_)
{
    return GLCD_L0_Write(pglcd_, (uint8_t)(GLCD_L1_InsBase_SetDispStartLine | (dsp_strt_ln_ & GLCD_L1_InsMask_SetDispStartLine)), GLCD_L0_FrameType_Instruction, hlf_);
}
